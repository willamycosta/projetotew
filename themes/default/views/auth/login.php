...
<head>
    ...
    <link href="<?= $assets ?>dist/css/styles1.css" rel="stylesheet" type="text/css" />
...
<body class="login-page login-page-<?= $Settings->theme_style; ?> rtl rtl-inv">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?=base_url();?>"><?= $Settings->site_name == 'SimplePOS' ? 'T&Wtrufas<b>POS</b>' : '<img src="'.base_url('uploads/'.$Settings->logo).'" alt="'.$Settings->site_name.'" />'; ?></a>
        </div>
        <div class="login-box-body">
            ...
            <div class="form-group has-feedback">
                <input type="text" name="identity" value="<?= set_value('identity', (DEMO ? 'willamycosta@hotmail.com' : '')); ?>" class="form-control" placeholder="<?= lang('email'); ?>" />
            ...
            <button type="submit" class="btn btn-primary btn-block btn-flat"><i class="glyphicon glyphicon-flash"></i> &nbsp;<?= lang('Entrar'); ?></button>
